    ...
    <div className="animate-in fade-in duration-500 pb-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="cyber-panel p-6 md:p-8 h-fit">
          <h3 className="text-xl font-bold text-gray-100 mb-6">Input Signature</h3>
          
          <div className="space-y-6">
            <div>
              <label className="block text-sm font-medium text-gray-300 mb-2">Sender's Public Key</label>
              {keysLoading ? (
            ...
            <div>
              <label className="block text-sm font-medium text-gray-300 mb-2">Signature Component (r)</label>
              <textarea 
            ...
            <div>
              <label className="block text-sm font-medium text-gray-300 mb-2">Signature Component (s)</label>
              <textarea 
                className="cyber-input min-h-[80px] resize-y font-mono text-sm text-green-400" 
            ...
            >
              {loading ? (
                <><Loader2 className="animate-spin mr-2" size={18} /> Verifying & Recovering...</>
              ) : (
        ...
        <div className="cyber-panel p-6 md:p-8">
          <h3 className="text-xl font-bold text-gray-100 mb-6">Verification Results</h3>
          
          {result ? (
            <div className="animate-in fade-in space-y-6">
              <div className={`p-4 border rounded-md ${result.isValid ? 'bg-green-500/10 border-green-500/50' : 'bg-red-500/10 border-red-500/50'}`}>
              ...
              <div>
                <label className="block text-sm font-medium text-gray-400 mb-2 uppercase tracking-wider">Recovered Plaintext Message</label>
                <div className={`p-4 rounded-md font-mono text-lg break-words border ${result.isValid ? 'bg-gray-950 border-green-500/30 text-green-400' : 'bg-gray-950 border-red-500/30 text-red-400'}`}>
