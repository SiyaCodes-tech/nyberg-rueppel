  ...
  return (
    <nav className="bg-gradient-to-r from-gray-900 via-[#064e3b] to-[#0f766e] border-b border-green-900/50 p-4 sticky top-0 z-50 shadow-[0_4px_20px_rgba(0,0,0,0.5)]">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between">
        <Link href="/" className="flex items-center space-x-2 text-green-400 font-extrabold text-2xl mb-4 md:mb-0 drop-shadow-[0_0_8px_rgba(74,222,128,0.8)] hover:scale-105 transition-transform">
