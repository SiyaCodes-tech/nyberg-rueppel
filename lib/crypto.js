...
export async function generateKeyPair(name = "Unnamed Key") {
  ...
  const q = BigInt("730750818665451621361119705777734429");
  const p = BigInt(
    "154003407916688874787552917489841704714710555504039375177988632843882866990532001",
  );
  const g = BigInt(
    "99978586346941469956567844174900505494928574834104636515466513644043503397517539",
  );
