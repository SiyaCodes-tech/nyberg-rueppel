      ...
      <div className="cyber-panel p-8 md:p-12 space-y-4">
        ...
        <section>
          ...
          <p className="text-gray-400 text-sm">
            ...
            Because of the Discrete Logarithm problem, nobody can figure out her secret <code>x</code> just by looking at <code>y</code>, <code>g</code>, and <code>p</code>.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-gray-400 text-sm">
            ...
            She sends ONLY <code>(r, s)</code> to Bob. The original message is nowhere to be seen in plain text!
          </p>
        </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-amber-900/10 p-6 rounded-lg border border-amber-900/50">
            ...
            <p className="text-sm text-gray-400">
              ...
              (This is why production systems use massive 2048-bit numbers!).
            </p>
          </div>
        </div>
      </div>
